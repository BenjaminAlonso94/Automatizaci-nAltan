...
public class AltanBatchPurchasesSupplementary {
	public void BatchPurchasesSupplementary(String ambiente, String oUser, String oPassword, String pId, String oId,
		...
		try {
			...
			myURL = new URL("https://altanredes-" + ambiente + ".apigee.net/cm/v1/subscribers/purchasessupplementary");
