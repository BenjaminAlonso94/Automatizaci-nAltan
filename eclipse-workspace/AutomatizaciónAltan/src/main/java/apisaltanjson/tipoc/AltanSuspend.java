...
public class AltanSuspend {

	public void consultarSuspend(String dn, String cDPrueba, String ambiente, String oUser, String oPassword,
		...
		try {
			myURL = new URL("https://altanredes-" + ambiente + ".apigee.net/cm/v1/subscribers/" + dn + "/suspend");
	...
	public void consultarSuspendG(String dn, String cDPrueba, String ambiente, String oUser, String oPassword,
			String pId, String oId, Herramientas herram, Word word) {
		URL myURL = null;
		HttpURLConnection myURLConnection = null;
		StringBuilder response;
	...
	public void consultarSuspendLoop(String dn, String cDPrueba, String ambiente, String oUser, String oPassword,
		...
		try {
			...
			if (estatusR.equals("Bad Request")) {
				...
				System.out.println("Termina prueba de APIGW Suspend con DN: " + dn);
				herram.escribirLogTrazas(rutaArchivoTraza, "Termina prueba de APIGW Suspend con DN: " + dn);
				herram.setBError(true);
				herram.readObjectJson(response.toString());
				if (herram.buscarCodeError(herram.getCodeStatus()) == true) {
					herram.escribirLog(rutaArchivoNOK, "Suspend", pId, dn, herram.getOrderId(),
							String.valueOf(codeResp), tiempoResp, 2, herram.getDescriptionCode());
					herram.escribirLog(rutaArchivoOK, "Suspend", pId, dn, herram.getOrderId(),
							String.valueOf(codeResp), tiempoResp, 2, herram.getDescriptionCode());
				} else {
					herram.escribirLog(rutaArchivoNOK, "Suspend", pId, dn, herram.getOrderId(),
				...
				herram.readObjectJson(response.toString());
				herram.setBError(false);
				herram.escribirLog(rutaArchivoOK, "Suspend", pId, dn, herram.getOrderId(), String.valueOf(codeResp),
						tiempoResp, 0, "");
			} else {
