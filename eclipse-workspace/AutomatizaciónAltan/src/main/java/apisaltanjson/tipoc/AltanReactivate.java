...
public class AltanReactivate {

	public void consultarReactive(String dn, String cDPrueba, String ambiente, String oUser, String oPassword,
		...
		try {
			myURL = new URL("https://altanredes-" + ambiente + ".apigee.net/cm/v1/subscribers/" + dn + "/reactivate");
	...
	public void consultarReactiveG(String dn, String cDPrueba, String ambiente, String oUser, String oPassword,
			String pId, String oId, Herramientas herram, Word word) {
		URL myURL = null;
		HttpURLConnection myURLConnection = null;
		StringBuilder response;
	...
	public void consultarReactiveLoop(String dn, String cDPrueba, String ambiente, String oUser, String oPassword,
		...
		try {
			...
			if (estatusR.equals("Bad Request")) {
				...
				System.out.println("Termina prueba de APIGW Reactivate con DN: " + dn);
				herram.escribirLogTrazas(rutaArchivoTraza, "Termina prueba de APIGW Reactivate con DN: " + dn);
				herram.setBError(true);
				herram.readObjectJson(response.toString());
				if (herram.buscarCodeError(herram.getCodeStatus()) == true) {
					herram.escribirLog(rutaArchivoNOK, "Reactivate", pId, dn, herram.getOrderId(),
							String.valueOf(codeResp), tiempoResp, 2, herram.getDescriptionCode());
					herram.escribirLog(rutaArchivoOK, "Reactivate", pId, dn, herram.getOrderId(),
							String.valueOf(codeResp), tiempoResp, 2, herram.getDescriptionCode());
				} else {
					herram.escribirLog(rutaArchivoNOK, "Reactivate", pId, dn, herram.getOrderId(),
