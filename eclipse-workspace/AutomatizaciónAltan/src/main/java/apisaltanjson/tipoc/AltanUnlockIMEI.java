...
public class AltanUnlockIMEI {
	public void consultarUnlockIMEI(String imei, String cDPrueba, String ambiente, String oUser, String oPassword,
		...
		try {
			myURL = new URL("https://altanredes-" + ambiente + ".apigee.net/cm/v1/imei/" + imei + "/unlock");
	...
	public void consultarUnlockIMEIG(String imei, String cDPrueba, String ambiente, String oUser, String oPassword,
			String pId, String oId, Herramientas herram, Word word) {
		URL myURL = null;
		HttpURLConnection myURLConnection = null;
		StringBuilder response;
