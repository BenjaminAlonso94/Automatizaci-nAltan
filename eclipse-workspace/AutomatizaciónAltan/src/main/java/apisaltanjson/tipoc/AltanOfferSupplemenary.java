...
public class AltanOfferSupplemenary {

	public void consultarOfferSupplemenary(String msisdn, String offerings, String cDPrueba, String ambiente,
		...
		try {
			myURL = new URL("https://altanredes-" + ambiente + ".apigee.net/cm/v1/products/purchase");
			...
			if (estatusR.equals("Bad Request")) {
				...
				word.CrearTitulo("Termina prueba de APIGW con msisdn: " + msisdn);
	...
	public void consultarOfferSupplemenaryG(String msisdn, String offerings, String cDPrueba, String ambiente,
			String oUser, String oPassword, String pId, String oId, Herramientas herram, Word word) {
		URL myURL = null;
		HttpURLConnection myURLConnection = null;
		StringBuilder response;
	...
	public void consultarOfferSupplemenaryLoop(String msisdn, String offerings, String cDPrueba, String ambiente,
			String oUser, String oPassword, String pId, String oId, Herramientas herram) {
		...
		try {
			...
			if (estatusR.equals("Bad Request")) {
				...
				System.out.println("Termina prueba de APIGW OfferSupplemenary con DN: " + msisdn);
				herram.escribirLogTrazas(rutaArchivoTraza,
						"Termina prueba de APIGW OfferSupplemenary con DN: " + msisdn);
				herram.setBError(true);
				herram.readObjectJson(response.toString());
				if (herram.buscarCodeError(herram.getCodeStatus()) == true) {
					herram.escribirLog(rutaArchivoNOK, "OfferSupplemenary", pId, msisdn, herram.getOrderId(),
							String.valueOf(codeResp), tiempoResp, 2, herram.getDescriptionCode());
					herram.escribirLog(rutaArchivoOK, "OfferSupplemenary", pId, msisdn, herram.getOrderId(),
							String.valueOf(codeResp), tiempoResp, 2, herram.getDescriptionCode());
				} else {
					herram.escribirLog(rutaArchivoNOK, "OfferSupplemenary", pId, msisdn, herram.getOrderId(),
			...
			System.out.println("Termina prueba de APIGW OfferSupplemenary con msisdn: " + msisdn);
			herram.escribirLogTrazas(rutaArchivoTraza, "Termina prueba de APIGW OfferSupplemenary con DN: " + msisdn);
			herram.setBError(true);
		}
	}
}
