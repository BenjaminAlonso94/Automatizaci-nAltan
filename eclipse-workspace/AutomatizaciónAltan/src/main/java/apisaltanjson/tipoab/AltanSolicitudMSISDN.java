...
public class AltanSolicitudMSISDN {
	public void SolicitudMSISDN(String ambiente, Herramientas herram, String oUser, String oPassword, String pId,
			String oId, String dn, String type, Word word) {
		URL myURL = null;
		...
		try {
			myURL = new URL("https://altanredes-" + ambiente + ".apigee.net/ac/v1/msisdns/reserve");
			...
			obj.put("numberPrefix", dn);
			obj.put("numberType", type);
			...
			if (estatusR.equals("Bad Request")) {
				...
				word.CrearTitulo("Termina prueba de solicitud de MSISDN con prefijo: " + dn);
