...
public class AltanActivateImsi {

	public void ActivateImsi(String ambiente, String imsis,Herramientas herram,String oUser, String oPassword, String pId, String oId, String dn,
			String coordenadas, String offeringId, Word word) {
		URL myURL = null;
		...
		try {
			myURL = new URL("https://altanredes-" + ambiente + ".apigee.net/ac/v1/imsis/"+imsis+"/activate");
			...
			if (estatusR.equals("Bad Request")) {
				...
				word.CrearTitulo("Termina prueba de notificación de activación con Imsi: " + imsis);
