...
public class AltanDeactivateImsi {
	public void DeactivateImsi(String ambiente, String imsis, Herramientas herram, String oUser, String oPassword,
		...
		try {
			myURL = new URL("https://altanredes-" + ambiente + ".apigee.net/ac/v1/imsis/" + imsis + "/deactivate");
			...
			if (estatusR.equals("Bad Request")) {
				...
				word.CrearTitulo("Termina prueba de notificación de desactivación con Imsi: " + imsis);
