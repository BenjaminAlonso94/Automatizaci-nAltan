...
public class AltanNotificacionCambioVinculacion {
	public void NotificacionCambioVinculacion(String ambiente, String imsis, Herramientas herram, String oUser,
		...
		try {
			...
			objA.put("be_id", pId);
			objA.put("msisdn", dn);
			objA.put("coordinates", coordenadas);
			objA.put("offeringId", offeringId);
			obj.put("updateLinking", objA);
			...
			if (estatusR.equals("Bad Request")) {
				...
				word.CrearTitulo("Termina prueba de notificación de cambio de vinculacion con Imsi: " + imsis);
