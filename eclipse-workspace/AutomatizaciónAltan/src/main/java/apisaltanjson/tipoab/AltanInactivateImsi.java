...
public class AltanInactivateImsi {
	public void InactivateImsi(String ambiente, String imsis, Herramientas herram, String oUser, String oPassword,
		...
		try {
			myURL = new URL("https://altanredes-" + ambiente + ".apigee.net/ac/v1/imsis/" + imsis + "/inactivate");
			...
			if (estatusR.equals("Bad Request")) {
				...
				word.CrearTitulo("Termina prueba de notificación de inactivación con Imsi: " + imsis);
